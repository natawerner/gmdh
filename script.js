...
document.onmousemove = function(){
  ...
  var newElement = document.createElement('img');
  p.appendChild(newElement);
  newElement.setAttribute('src', overlays[m]);},
  4000);
}
/*
document.onmousemove = function() {
